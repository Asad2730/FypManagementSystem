...
<div class="w-1/4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Student  Name</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Supervisor  Name</p>
        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Coordinator  Name</p>
        <button 
